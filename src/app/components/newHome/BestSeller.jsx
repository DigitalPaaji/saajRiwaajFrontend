...
// console.log(item._id.slice(-2).charCodeAt()+new Date(Date.now()).getDate(),"ddddddd")
...
//               bg-gradient-to-r from-[#bc861a] via-[#f1d981] to-[#bc861a]   text-[#292927]  font-semibold py-2.5 text-xs  
//               transform translate-y-4 group-hover:-translate-y-1 
//               transition-all duration-500 ease-out flex items-center justify-center gap-2"
//           >
//             <ShoppingBag size={16} />
