        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center items-center text-center">
          ...
          <div className="w-full max-w-sm flex flex-col gap-3">
            ...
            <button 
              ...
              className="w-full py-3.5 rounded-xl font-bold transition-transform hover:scale-[1.02] bg-gradient-to-r from-[#bc861a] via-[#f1d981] to-[#bc861a] text-[#292927] flex items-center justify-center gap-2 shadow-md"
            >
