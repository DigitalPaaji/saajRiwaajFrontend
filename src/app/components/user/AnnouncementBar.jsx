...
export default function AnnouncementBar() {
  ...
  return (
    <div className="relative bg-amber-50/30 text-amber-800 py-3 overflow-hidden text-center font-semibold">
      <span> Shop Elegant Jewellery with Special Offers and Free Shipping on Every Order ✨ Timeless Designs for Every Occasion  </span>
      {/* <button 
      ...
      {/* <div className="flex items-center gap-2">
        <div className="whitespace-nowrap animate-marquee flex items-center gap-4 text-center">
         
            <span  className="flex items-center gap-1 text-lg font-medium px-4">
